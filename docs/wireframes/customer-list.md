...
- Thanh search luôn nằm trước filter để ưu tiên hành vi tra cứu nhanh khi danh sách lớn.
- Khi người dùng chọn một status card, hệ thống áp dụng filter tương ứng và đồng bộ chip filter phía trên bảng.
- Bulk action bar dùng vị trí sticky ở cuối viewport trên desktop để không che header bảng.
- Cột trạng thái khách hàng và trạng thái công nợ phải hiển thị đồng thời khi khách vừa Active vừa Overdue.
